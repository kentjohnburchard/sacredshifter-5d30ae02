  ...
  return (
    <Layout pageTitle="Heart Center">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6 text-center text-white text-contrast-high">Heart Center</h1>
        ...
        <div className="space-y-16">
          <section className="py-8">
            <Card className="bg-black/60 border-pink-500/30 backdrop-blur-md p-6 shadow-lg">
              <h2 className="text-2xl font-bold mb-4 text-center text-pink-200">Love Dashboard</h2>
              <LoveDashboard />
            </Card>
          </section>
          ...
          <section className="py-8">
            <Card className="bg-black/60 border-pink-500/30 backdrop-blur-md p-6 shadow-lg">
              <h2 className="text-2xl font-bold mb-4 text-center text-pink-200">Mirror Portal</h2>
              <MirrorPortal />
            </Card>
          </section>
          ...
          <section className="py-8">
            <Card className="bg-black/60 border-pink-500/30 backdrop-blur-md p-6 shadow-lg">
              <h2 className="text-2xl font-bold mb-4 text-center text-pink-200">Soul Hug</h2>
              <SoulHug />
            </Card>
          </section>
          ...
          <section className="py-8">
            <Card className="bg-black/60 border-pink-500/30 backdrop-blur-md p-6 shadow-lg">
              <h2 className="text-2xl font-bold mb-4 text-center text-pink-200">Heart Frequency Playlists</h2>
