    ...
    >
      <div className="relative min-h-screen flex flex-col items-center justify-center p-4 md:p-8">
        ...
        >
          ...
          >
            {/* Sacred Journeys Tile - Links to Dashboard */}
            <motion.div 
            ...
            {/* Sacred Spectrum Tile - Links to Alignment */}
            <motion.div 
            ...
            <motion.div 
              ...
              onClick={() => navigate('/reality-optimizer')}
            >
