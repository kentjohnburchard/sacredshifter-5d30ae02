...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[url('/lovable-uploads/03d64fc7-3a06-4a05-bb16-d5f23d3983f5.png')] bg-cover bg-center bg-fixed">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-indigo-900/70 via-purple-900/60 to-black/90 backdrop-blur-sm -z-10"></div>
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 py-8 sm:px-6 space-y-8">
        <div className="text-center space-y-3 mb-8 animate-fade-in">
          <h2 className="text-4xl sm:text-5xl font-light tracking-tight">
            <span className="font-medium bg-clip-text text-transparent bg-gradient-to-r from-amber-200 via-purple-200 to-blue-200">
        ...
        {/* Introduction Card */}
        <Card className="border-none shadow-xl glass bg-black/30 backdrop-blur-md border border-white/10 overflow-hidden mb-10">
          <CardContent className="p-6 text-white">
            <h3 className="text-2xl font-light mb-4 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-purple-200">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="glass bg-black/30 backdrop-blur-md border border-white/10 rounded-lg shadow-lg">
              <TabsList className="grid grid-cols-3 bg-transparent border-b border-white/10 w-full rounded-t-lg">
                ...
                <TabsTrigger value="meditation" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-slate-200">
              ...
              <ScrollArea className="h-72 p-5 text-white">
                ...
                <TabsContent value="history" className="space-y-4 mt-0">
                  <h3 className="text-xl font-medium text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-purple-200">
                    Historical Origins
                  </h3>
                  <p className="text-slate-200">
                    ...
                    <ul className="space-y-2">
                      {selectedFrequency.meditations.map((meditation, index) => (
                        <li key={index} className="flex items-start">
                          ...
                          <span className="text-slate-200">{meditation}</span>
                        </li>
                      ))}
                    </ul>
                  ) : (
        ...
        <Card className="mt-12 border-none shadow-xl glass bg-black/30 backdrop-blur-md border border-white/10">
          <CardContent className="p-6 md:p-8">
            <div className="space-y-6 text-white">
              <h3 className="text-2xl font-light text-center mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-200 to-blue-200">
