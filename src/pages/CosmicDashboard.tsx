...
import { AnimatedBackground, CosmicContainer, SacredGeometryVisualizer, CosmicFooter } from "@/components/sacred-geometry";
...
const CosmicDashboard = () => {
  ...
  return (
    <AnimatedBackground intensity="medium" theme="cosmic">
